...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chartFragment=new ChartsFragment();
        budgetFragment=new BudgetFragment();

        setFragment(dashBoardFragment);
        //Select The Menu Item From BottomNavigationView and open That Fragment
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch(item.getItemId()){
                    ...
                    case (R.id.dashboard):
                        setFragment(dashBoardFragment);
                        bottomNavigationView.setItemBackgroundResource(R.color.SkyBlueDark);
                        return true;
    ...
    //Function To Select The Fragment
    ...
    public void onBackPressed() {
        ...
        if(drawerLayout.isDrawerOpen(GravityCompat.END)){
            ...
            if (currentFragment instanceof ChartsFragment) {
                return;
            }
    ...
    //Function to Select Item From Navigation Drawer
    public void displaySelectedListener(int itemId){
        ...
        //To close Drawer Automatically when selected Item from navigation view
        DrawerLayout drawerLayout=findViewById(R.id.drawer_layout);
